...
export interface GameCoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export namespace CoreUpdatedEvent {
  export type InputTuple = [newCore: AddressLike];
  export type OutputTuple = [newCore: string];
  export interface OutputObject {
    newCore: string;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface GameCoin extends BaseContract {
  connect(runner?: ContractRunner | null): GameCoin;
  waitForDeployment(): Promise<this>;

  interface: GameCoinInterface;
  ...
  mintReward: TypedContractMethod<
    [to: AddressLike, amountCoins: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  ratePerEth: TypedContractMethod<[], [bigint], "view">;
  ...
  getEvent(
    ...
    CoreUpdatedEvent.InputTuple,
    CoreUpdatedEvent.OutputTuple,
    CoreUpdatedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "CoreUpdated(address)": TypedContractEvent<
      CoreUpdatedEvent.InputTuple,
      CoreUpdatedEvent.OutputTuple,
      CoreUpdatedEvent.OutputObject
    >;
    CoreUpdated: TypedContractEvent<
      CoreUpdatedEvent.InputTuple,
      CoreUpdatedEvent.OutputTuple,
      CoreUpdatedEvent.OutputObject
    >;
